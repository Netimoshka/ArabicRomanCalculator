...
public class ArabicRomanCalculator {
    ...
    {
        System.out.println("Введите два числа от 1 до 10 в виде арабских (1...9) или римских (I...X) символов со знаком алгебраической операции между ними, и нажмите Enter ");
        ...
        }//проводим первичную проверку - во введённом выражении должно быть три составляющих и вторая составляющая должжна быть знаком алгебраической операции
